...
public static class TextureFilter
{
	...
	public static float[][] LinearKernel(int size)
	{

		return LinearKernel(size, true);

	}
	/// 
	public static float[][] LinearKernel(int size, bool normalize)
	{
	...
	/// 
	public static float[][] GaussianKernel(float sigma, int size)
	{
		return 	GaussianKernel(sigma, size, true);

	}
	/// 
	public static float[][] GaussianKernel(float sigma, int size, bool normalize)
	{
		float[][] kernel = new float[size][];
	...
	// Do not normalize
	public static readonly float[][] EMBOSS = new float[3][]
	{
		new float[3]{ -1, 0, 0 },
		new float[3]{ 0, 0, 0 },
		new float[3]{ 0, 0, 1 }
